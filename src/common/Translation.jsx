...
const resources = {
  ...
  fr: {
    translation: {
        font: "font-poppins",
        dir: "ltr",
        topHeader: "Vente d'été pour tous les maillots de bain et livraison express gratuite - 50% de réduction !",
        ...
        homeSections: {
            row1: {
                col1: [
                    ...
                    "Sports et plein air",
                    "Bébés et jouets",
                    "Épicerie et animaux de compagnie",
                    "Santé et beauté",
                ],
                col2: ["Série iPhone 14", "Jusqu'à 10% de réduction avec le bon", "Achetez maintenant"],
            },
            row2: ["Ventes flash d'aujourd'hui", "Jours", "Heures", "Minutes", "Secondes"],
        },
        ...
        itemsArray: {
            0: {
                ...
                type: "Jeux",
                details: "Une voiture électrique passionnante pour les enfants, pour conduire avec style, offrant des heures de divertissement et de plaisir.",
            },
            1: {
                title: "Appareil photo reflex numérique CANON EOS",
                type: "Technologie",
                details: "Capturez des photos et des vidéos époustouflantes avec cet appareil photo reflex numérique professionnel Canon, parfait pour les amateurs de photographie.",
            },
            2: {
                title: "Nourriture sèche pour chien Breed",
                type: "Général",
                details: "Nourriture sèche nutritive pour garder votre ami à quatre pattes en bonne santé et heureux, fabriquée avec des ingrédients de haute qualité.",
            },
            3: {
              title: "Ordinateur portable de jeu ASUS FHD",
              type: "Technologie",
              details:
                "Découvrez le jeu haute performance avec cet ordinateur portable de jeu ASUS FHD, doté de graphismes avancés et d'un gameplay fluide.",
            },
            4: {
              title: "Ensemble de produits Curology",
              type: "Général",
              details:
                "Un ensemble de soins de la peau complet par Curology pour nettoyer, hydrater et protéger votre peau, la laissant douce et radieuse.",
            },
            5: {
              title: "Manette de jeu USB GP11 Shooter",
              type: "Jeu vidéo",
              details:
                "Améliorez votre expérience de jeu avec la manette de jeu USB GP11 Shooter, dotée d'une construction de haute qualité et de commandes précises.",
            },
            6: {
              title: "Veste matelassée en satin",
              type: "Vêtements",
              details:
                "Restez élégant et au chaud avec cette veste matelassée en satin, parfaite pour ajouter une touche tendance à votre tenue.",
            },
            7: {
              title: "Petite étagère à livres",
              type: "Général",
              details:
                "Organisez vos livres et objets décoratifs de manière ordonnée avec cette petite étagère à livres, conçue pour s'intégrer dans des espaces compacts.",
            },
            8: {
              title: "Refroidisseur liquide RGB pour CPU",
              type: "Technologie",
              details:
                "Gardez votre CPU frais et fonctionnant en douceur avec le refroidisseur liquide RGB pour CPU, doté d'une pompe haute performance et d'un éclairage RGB personnalisable.",
            },
            9: {
              title: "Sac de voyage Gucci",
              type: "Vêtements",
              details:
                "Voyagez avec style avec le sac de voyage Gucci, fabriqué à partir de matériaux de première qualité et conçu pour la durabilité et le luxe.",
            },
            10: {
              title: "Manteau The North",
              type: "Vêtements",
              details:
                "Restez au chaud et à la mode avec le manteau The North, doté d'une construction durable et d'un design intemporel.",
            },
            11: {
              title: "Manette de jeu HAVIT HV-G92",
              type: "Jeu vidéo",
              details:
                "Profitez de commandes de jeu réactives et précises avec la manette de jeu HAVIT HV-G92, conçue pour des heures de plaisir de jeu.",
            },
            12: {
              title: "Clavier filaire AK-900",
              type: "Technologie",
              details:
                "Tapez rapidement et avec précision grâce au clavier filaire AK-900, doté d'une construction durable et d'un design ergonomique.",
            },
            13: {
              title: "Moniteur de jeu IPS LCD",
              type: "Technologie",
              details:
                "Plongez-vous dans le jeu avec le moniteur de jeu IPS LCD, offrant des visuels vibrants et un gameplay fluide.",
            },
            14: {
              title: "Chaise confort de la série S",
              type: "Vêtements",
              details:
                "Détendez-vous confortablement avec la chaise confort de la série S, dotée d'un design ergonomique et d'un rembourrage moelleux pour de longues heures d'assise.",
            },
            15: {
              title: "JBL Boombox 2",
              type: "Nouveauté",
              details:
                "Découvrez un son puissant avec le JBL Boombox 2, doté d'un design robuste et d'une longue autonomie pour une écoute toute la journée.",
            },
            16: {
              title: "Parfum",
              type: "Nouveauté",
              details:
                "Ce parfum est un mélange de oud, de rose et d'encens, créant un parfum riche et luxueux qui dure toute la journée.",
            },
            17: {
              title: "Téléphone",
              type: "Nouveauté",
              details:
                "Ce téléphone dispose d'un grand écran, d'un processeur puissant et d'une longue autonomie de batterie, parfait pour le travail et le jeu.",
            },
            18: {
              title: "PlayStation 5",
              type: "Nouveauté",
              details:
                "La version noire et blanche de la PS5 est en vente.",
            },
            19: {
              title: "Enceinte",
              type: "Nouveauté",
              details: "Qualité sonore incroyable avec l'enceinte sans fil Amazon.",
            },
            20: {
              title: "Collections pour femmes",
              type: "Nouveauté",
              details:
                "Les collections pour femmes sont présentées pour vous donner une autre ambiance, et vous pouvez trouver les meilleures collections ici.",
            },
            21: {
              title: "Chaussures de football",
              type: "Nouveauté",
              details:
                "Les meilleures chaussures de football pour votre jeu, et vous pouvez trouver les meilleures collections ici.",
            },            
        },
        categories: {
            general: "Général",
        ...
        services: {
            ...
            3: {
                ...
                description: "Nous remboursons l'argent dans les 30 jours",
            },
        },
        redButtons: {
        ...
        productPage: {
          ...
          2: "Retour gratuit",
          2.1: "Détails des retours gratuits dans les 30 jours.",
        },
        contactPage: {
          call: "Nous appeler",
          available: "Nous sommes disponibles 24h/24 et 7j/7.",
          phone: "Téléphone",
          write: "Écrivez-nous",
          fillForm: "Remplissez notre formulaire et nous vous contacterons dans les 24 heures.",
          emails: "E-mails",
          yourName: "Votre nom",
        ...
        aboutPage: {
          ...
          paragraph1:
            "Lancé en 2015, Exclusive est le principal marché en ligne d'Asie du Sud avec une présence active au Bangladesh. Soutenu par une large gamme de solutions marketing, de données et de services sur mesure, Exclusive compte 10 500 vendeurs et 300 marques et sert 3 millions de clients dans la région.",
          paragraph2:
            "Exclusive propose plus de 1 million de produits, en pleine croissance. Exclusive offre une gamme diversifiée dans des catégories allant de la consommation.",
          card1: "Vendeurs actifs sur notre site",
          card2: "Ventes mensuelles de produits",
          card3: "Clients actifs sur notre site",
          card4: "Ventes brutes annuelles sur notre site",
          k1: "10.5k",
          k2: "33k",
          k3: "45.5k",
          k4: "25k",
          ...
          name3: "Will Smith",
          name4: "Tom Hardy",
          job1: "Fondateur et Président",
          job2: "CTO",
          job3: "PDG",
          job4: "Designer de produit",
        },
        signUpPage: {
        ...
        Snackbar: {
          ...
          movedToCart: "Articles ajoutés au panier avec succès !",
        ...
        featured: {
          ...
          playStation: {
            title: "PlayStation 5",
            description: "La version noire et blanche de la PS5 est en vente.",
          },
          WomenCollections: {
            title: "Collections pour femmes",
            description: "Collections pour femmes en vedette qui vous donnent une autre ambiance.",
          },
          speakers: {
            title: "Enceintes",
            description: "Enceintes sans fil Amazon",
          },
          perfume: {
            title: "Parfum",
            description: "GUCCI INTENSE OUD EDP",
        ...
        footer: {
          ...
          save: "Économisez 3 $ avec l'application Nouvel utilisateur uniquement",
          support: "Support",
          address: "111 Bijoy sarani, Dhaka, DH 1515, Bangladesh",
          ...
          FAQ: "FAQ",
          Contact: "Contact",
          copyrights: "© Droit d'auteur Rimel 2022. Tous droits réservés",
